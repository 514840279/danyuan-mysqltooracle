...
import org.danyuan.utils.projectpath.ProjectPath;
...
public class ImagePreProcess6 {
	...
	public static Map<BufferedImage, String> loadTrainData() throws Exception {
		...
		ProjectPath path = new ProjectPath();
		File dir = new File(path.getProjectRootPath("pic"));
	...
	public static String getAllOcr(String file, int i) throws Exception {
		...
		ProjectPath path = new ProjectPath();
		BufferedImage img = removeBackgroud(path.getProjectRootPath("img") + "/" + file);
		//System.err.println(img);
		/**
		 * 下载整个去掉背景的图片
		 */
		//ImageIO.write(img, "JPG", new File("d:\\yzm\\picture\\"+i+".jpg"));
		...
		ImageIO.write(img, "JPG", new File(path.getProjectRootPath("result") + "\\" + result + ".jpg"));
		return result;
	}
